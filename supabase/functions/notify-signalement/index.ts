/* ============================================================
   ...
   le navigateur/appareil de l'enseignant (pas de bloqueur de pub,
   pas de page fermée trop tôt).
...
/** Récupère type/modèle/référence de l'équipement pour enrichir l'email. */
...
Deno.serve(async (req) => {
  ...
  // Garde : seul le trigger (qui connaît le secret) peut déclencher l'envoi.
  ...
  const template_params = {
    ...
    enseignant: record.enseignant_nom,
    email: record.enseignant_email || '—',
